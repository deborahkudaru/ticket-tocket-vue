...
<template>
  <div>
    <div class="z-10 bg-gray-50 py-20 px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            <div class="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mb-6">
              <i class="pi pi-ticket text-slate-700 text-3xl"></i>
            </div>
          ...
          <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            <div class="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mb-6">
              <i class="pi pi-lock text-slate-700 text-3xl"></i>
            </div>
          ...
          <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            <div class="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mb-6">
              <i class="pi pi-bolt text-slate-700 text-3xl"></i>
            </div>
            <h3 class="text-2xl font-bold text-gray-900 mb-3">Instant Delivery</h3>
            <p class="text-gray-600 leading-relaxed">
