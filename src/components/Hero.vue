...
<template>
  <div class="relative min-h-screen overflow-hidden">
    ...
    <div class="absolute bottom-60 left-1/4 w-40 h-40 bg-slate-300 rounded-full opacity-80"></div>
    <div class="absolute top-1/3 right-10 w-24 h-24 bg-slate-600 rounded-full opacity-75"></div>
    <div class="absolute bottom-40 right-1/3 w-36 h-36 bg-slate-200 rounded-full opacity-70"></div>
    ...
    <div class="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
      ...
      <div class="mb-12">
        <router-link
          to="/auth/signup"
          class="px-8 py-3 bg-slate-700 text-white rounded-lg font-semibold hover:bg-slate-800 transition-all transform hover:scale-105 shadow-lg inline-block"
        >
          Get Started
        </router-link>
        <router-link
          to="/auth/login"
          class="ml-4 px-8 py-3 bg-white border border-slate-700 text-gray-800 rounded-lg font-semibold hover:bg-slate-800 hover:text-white transition-all transform hover:scale-105 shadow-lg inline-block"
        >
          Login
        </router-link>
      </div>
